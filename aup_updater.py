        ...
        for issuer_key, issuer_info in ISSUERS.items():
            ...
            for filing in filings:
                ...
                _is_cover_form = (
                    ...
                    or "15ga1" in _exhibit_fn or "15ga-1" in _exhibit_fn
                )
                _raw = (aup_data or {}).get("raw_text") or ""
                _is_no_activity = "no activity to report" in _raw.lower()
                if (_is_cover_form or _is_no_activity) and not _has_data:
                    logger.info(
